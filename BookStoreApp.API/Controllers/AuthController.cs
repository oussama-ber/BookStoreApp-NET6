...
namespace BookStoreApp.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        {
            logger.LogInformation($"Login Attemp for {userDto.Email}");
            try
            {
                ...
                logger.LogInformation($"tokenString {tokenString}");
                return response;
            }
            catch (Exception ex)
            {
                logger.LogError(ex, $"Something Went Wrong in {nameof(Login)}");
